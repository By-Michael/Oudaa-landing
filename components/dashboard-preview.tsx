      ...
      <div className="relative p-6 rounded-2xl glassmorphism glow-border overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-foreground">Community Dashboard</h3>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-3 rounded-lg bg-background/50 border border-primary/20 hover:border-primary/40 transition">
              <p className="text-xs text-slate-400 mb-1">Fund Balance</p>
              <p className="text-2xl font-bold text-primary">$48,210</p>
            </div>
            <div className="p-3 rounded-lg bg-background/50 border border-accent/20 hover:border-accent/40 transition">
              <p className="text-xs text-slate-400 mb-1">Dues Collected</p>
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              {[
                { icon: CheckCircle2, label: "Bank payment verified — Unit 12B", color: "text-primary" },
                { icon: Landmark, label: "New capital project funded", color: "text-accent" },
                { icon: Wallet, label: "Expense logged to ledger", color: "text-slate-400" },
              ].map((item, i) => (
                <div
                  key={i}
